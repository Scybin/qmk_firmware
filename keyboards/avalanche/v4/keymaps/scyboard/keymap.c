...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        TD(LOSRS), KC_LCTL,        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                                             KC_H,      KC_J,    KC_K,     KC_L,    KC_SCLN, KC_QUOT, KC_RBRC,
                   TD(SHIFT_CAPS), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      TD(LLIGHT), XXXXXXX, XXXXXXX, KC_RALT, KC_N,      KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, KC_BSLS,
                                                     EE_CLR,  XXXXXXX, MO(LOWER), KC_SPC,     KC_LWIN, KC_ENT,  KC_BSPC, MO(UPPER), DF(DEV), DF(OSRS)
    ),                                                                                                                                             
    [LIGHT] = LAYOUT(                                                                                                                              
    ...
    [DEV] = LAYOUT(                                                                                                                                    
        ...
        XXXXXXX,   KC_LCTL,        XXXXXXX, XXXXXXX, XXXXXXX, KC_W,    XXXXXXX,                                          XXXXXXX,   KC_UP,   XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                   XXXXXXX,        XXXXXXX, KC_E,    KC_A,    KC_S,    KC_D,      XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT,   KC_DOWN, KC_RIGHT, XXXXXXX, XXXXXXX, XXXXXXX,
