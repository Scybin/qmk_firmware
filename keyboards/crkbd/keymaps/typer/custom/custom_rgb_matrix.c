...
uint8_t g_rgb_frame_buffer_leds_hack[RGB_MATRIX_LED_COUNT] = {0};
...
#    endif // defined(RGB_MATRIX_KEYRELEASES)
    {
        if (rgb_matrix_config.mode == RGB_MATRIX_CUSTOM_TYPING_HEATMAP) {
            process_rgb_matrix_CUSTOM_TYPING_HEATMAP(row, col);
        }
    }
